...
public class CryptoCurrencyController {
    ...
    public ResponseEntity<CryptoCurrency> addCryptoCurrency(
            @RequestBody CryptoCurrency currency) {
        CryptoCurrency newCryptoCurrency = cryptoCurrencyService.saveOrUpdate(currency);
        return new ResponseEntity<>(newCryptoCurrency, HttpStatus.CREATED);
    }
